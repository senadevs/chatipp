...
import 'kleur/colors';
import { B as Button, c as cn, I as Input, u as useToast, a as useAuth, $ as $$Layout } from '../chunks/input_9xorTJV3.mjs';
import { jsxs, jsx, Fragment } from 'react/jsx-runtime';
import { useState, useRef, useEffect } from 'react';
import { H as HoverCard, a as HoverCardTrigger, b as HoverCardContent, S as ScrollArea } from '../chunks/hover-card_B7bHlHqE.mjs';
import { Check, Copy, FileText, MessageSquare, Bot, Music, Film, Image, Paperclip, Send, ChevronRight, ChevronLeft } from 'lucide-react';
...
function Message({ message, isSelected }) {
  return /* @__PURE__ */ jsx(
    "div",
    {
...
function ModeSwitch({ mode, onModeChange }) {
  return /* @__PURE__ */ jsxs("div", { className: "relative inline-flex h-9 rounded-full border bg-muted p-1 hover:bg-muted/80", children: [
    /* @__PURE__ */ jsx(
      "button",
      {
        className: cn(
...
function ModelSelector({ selectedModel, onModelSelect }) {
  return /* @__PURE__ */ jsx("div", { className: "flex flex-wrap gap-2", children: AI_MODELS.map((model) => /* @__PURE__ */ jsxs(HoverCard, { children: [
...
function ChatInput({
  ...
  return /* @__PURE__ */ jsxs("div", { className: "space-y-4", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex gap-2", children: [
      ...
      /* @__PURE__ */ jsx(Button, { onClick: onSend, size: "icon", children: /* @__PURE__ */ jsx(Send, { className: "h-4 w-4" }) })
    ] }),
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex-1 flex flex-col", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "p-4 border-t border-border bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60", children: /* @__PURE__ */ jsxs("div", { className: "max-w-3xl mx-auto space-y-4", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4 mb-2", children: [
          /* @__PURE__ */ jsx(ModeSwitch, { mode: chatMode, onModeChange: setChatMode }),
          /* @__PURE__ */ jsx(ModelSelector, { selectedModel, onModelSelect: setSelectedModel })
        ] }),
        /* @__PURE__ */ jsx(
          ChatInput,
          {
...
const $$Chat = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Public Chat" }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="container mx-auto px-4"> ${renderComponent($$result2, "Chat2", Chat, { "client:load": true, "client:component-hydration": "load", "client:component-path": "C:/Users/Rebe/Desktop/chati/src/components/chat/Chat", "client:component-export": "default" })} </div> ` })}`;
}, "C:/Users/Rebe/Desktop/chati/src/pages/chat.astro", void 0);

const $$file = "C:/Users/Rebe/Desktop/chati/src/pages/chat.astro";
const $$url = "/chat";
